...
**Project-local workflow:**
 ...
 |-------------------|--------------------------------------------|
 | `$openspec-new-change (Codex) or /openspec-new-change (other agents)` | Create a change step by step              |
 ...
 | `$openspec-verify-change (Codex) or /openspec-verify-change (other agents)` | Verify implementation and evidence         |
 | `$openspec-archive-change (Codex) or /openspec-archive-change (other agents)` | Archive a completed change                 |

**Additional project-local commands:**
 ...
 | `$openspec-sync-specs (Codex) or /openspec-sync-specs (other agents)`       | Sync accepted delta specs                                 |

---

## What's Next?

Try `$openspec-new-change (Codex) or /openspec-new-change (other agents)` on something you actually want to build, or use `$openspec-ff-change (Codex) or /openspec-ff-change (other agents)` to create all planning artifacts at once. You've got the rhythm now!
```
...
**Project-local workflow:**
 ...
 | Command                  | What it does                               |
 |--------------------------|--------------------------------------------|
 | `$openspec-new-change (Codex) or /openspec-new-change (other agents) <name>` | Create a change step by step               |
 ...
 | `$openspec-verify-change (Codex) or /openspec-verify-change (other agents) <name>`   | Verify implementation and evidence         |
...
**Additional project-local commands:**
 ...
 | `$openspec-sync-specs (Codex) or /openspec-sync-specs (other agents) <name>`       | Sync accepted delta specs            |

Try `$openspec-new-change (Codex) or /openspec-new-change (other agents)` to start your first change.
```
